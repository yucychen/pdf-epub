# -*- coding: utf-8 -*-
"""一键生成 pdf-epub 项目所有文件 (Python 版,跨平台)"""
import os
import textwrap
...
# ==================== pdf2epub_gui.py ====================
FILES["pdf2epub_gui.py"] = r'''"""GUI 包装,基于 tkinter"""
import os
import threading
...
# ==================== make_icon.py ====================
FILES["make_icon.py"] = r'''"""用 Pillow 生成应用图标 (assets/icon.ico / icon.icns / icon.png)"""
import os
import sys
...
# ==================== pdf2epub.spec ====================
FILES["pdf2epub.spec"] = r'''# -*- mode: python ; coding: utf-8 -*-
...
def main():
    ...
    print("\nNext steps:")
    print("  git add .")
    print('  git commit -m "feat: PDF->EPUB tool full version"')
